...
BtorNode *btor_rewrite_slice_exp (Btor * btor, BtorNode * exp, int upper, 
                                  int lower);
...
BtorNode *btor_rewrite_cond_exp (Btor * btor, BtorNode * e_cond, 
                                 BtorNode * e_if, BtorNode *e_else);

BtorNode *btor_rewrite_apply_exp (Btor * btor, BtorNode * fun, BtorNode * args);

BtorNode *btor_rewrite_lambda_exp (Btor * btor, BtorNode * param,
                                   BtorNode * body);

int btor_rewrite_linear_term (Btor * btor, BtorNode * term, char **fp, 
                              BtorNode ** lp, BtorNode ** rp);
#endif
