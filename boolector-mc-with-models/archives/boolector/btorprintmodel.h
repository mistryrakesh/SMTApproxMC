...
void btor_get_fun_model_str (Btor * btor,
                             BtorNode * exp,
                             char *** args,
                             char *** values,
                             int * size);  
void btor_get_fun_model_str_aux (
                             Btor * btor,
                             BtorPtrHashTable ** bv_model,
                             BtorPtrHashTable ** fun_model,
                             BtorNode * exp,
...
/* rakesh - 2015-06-18 - added function to generate constraint from model */
BoolectorNode* btor_gen_model_constraint(Btor * btor);

void btor_print_value (Btor * btor,
                       BtorNode * exp,
                       char * exp_str, 
                       char * format,
                       FILE * file);
