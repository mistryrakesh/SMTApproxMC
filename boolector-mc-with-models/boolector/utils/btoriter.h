...
void init_parameterized_iterator (
         Btor *, BtorParameterizedIterator *, BtorNode *);
...
void init_reversed_hash_table_iterator (
         BtorHashTableIterator *, BtorPtrHashTable *);
...
void init_node_hash_table_iterator (
         BtorHashTableIterator *, BtorPtrHashTable *);
void init_reversed_node_hash_table_iterator (
         BtorHashTableIterator *, BtorPtrHashTable *);
void queue_node_hash_table_iterator (
          BtorHashTableIterator *, BtorPtrHashTable *);
