...
def generateXorConstraint(varMap):
    ...
    lhsStr = functools.reduce(lambda x, y: xorExpr(x, y), xorBitList)
    rhsStr = "true" if (random.random() >= 0.5) else  "false"
...
def main(argv):
    ...
    for i in range(numIterations):
        ...
        iterationRunResults.append((len(constraintList), numSolutions)) # append number of constraints added and number of solutions in last case
    ...
    for numConstraints, numSolutions in iterationRunResults:
        finalOutputFile.write(str(numConstraints) + ", ")
