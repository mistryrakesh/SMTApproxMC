...
BtorBVAssignmentList * btor_clone_bv_assignment_list (
    BtorMemMgr *, BtorBVAssignmentList *);
...
BtorArrayAssignment * btor_get_array_assignment (
    const char **, const char **, int);

/* Get indices and values references from BtorArrayAssignment bucket. */
void btor_get_array_assignment_indices_values (
    BtorArrayAssignment *, char ***, char ***, int size);

/* Create new array assignment and add it to the list. */
BtorArrayAssignment * btor_new_array_assignment (
    BtorArrayAssignmentList *, char **, char **, int);

/* Release array assignment and remove it from the list. */
void btor_release_array_assignment (
    BtorArrayAssignmentList *, char **, char **, int);
